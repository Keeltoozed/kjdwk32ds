...
MIN_AGE_MINUTES = 720  # ЖЕСТКИЙ ФИЛЬТР: Монете должно быть минимум 12 часов. Это отсеивает 99.9% моментальных скамов.
MAX_AGE_MINUTES = 43200 # Увеличили максимальный возраст до 30 дней (вместо 1 дня)
